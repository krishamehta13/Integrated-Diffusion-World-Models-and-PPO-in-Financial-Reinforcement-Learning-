...
| :--- | :---: | :---: |
| **Final Return %** | 12.81% | **38.03%** |
| **Max Drawdown %** | 18.09% | **15.73%** |
| **Sharpe Ratio** | 0.34 | **0.78** |
...
2. **Improved Risk Control & Volatility Penalty**: By training with a downside volatility penalty on synthetic future trajectories generated by the diffusion world model, the agent achieved a **near-doubling of the Sharpe Ratio (0.78 vs 0.34)** and a **2.36% reduction in drawdown** under out-of-distribution (OOD) test periods.
